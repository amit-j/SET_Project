...
//            result = findNextLiteral(subquery.substring(startIndex, subquery.indexOf('-')-1), startIndex);
//            Literal temp = findNextLiteral(subquery.substring(startIndex), subquery.indexOf('-'));
//
//        }
//        if(result != null)
//            return result;
